        ...
        <div className="w-full p-5">
          <div className="max-w-2xl relative">
            ...
            <div className="relative z-10 pointer-events-auto p-2">
              ...
              <p className='text-white text-xs md:text-sm md:mb-6 mb-10'>A virtual space where you can leave anonymous notes on the walls. Share your thoughts, ideas, or perspectives with others. "Right-click" anywhere on the walls if using pc to create a new note.</p>
            </div>
          </div>
        </div>
      </div>
